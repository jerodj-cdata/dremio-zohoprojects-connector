...
@SourceType(value = "ZohoProjectsARP", label = "ZohoProjects",uiConfig = "zohoprojects-layout.json")
public class ZohoProjectsConf extends AbstractArpConf<ZohoProjectsConf> {
  private static final String ARP_FILENAME = "arp/implementation/zohoprojects-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.zohoprojects.ZohoProjectsDriver";
